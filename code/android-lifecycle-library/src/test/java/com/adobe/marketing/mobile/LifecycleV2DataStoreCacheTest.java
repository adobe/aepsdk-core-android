...
public class LifecycleV2DataStoreCacheTest {
	...
	public void testConstructor_getCloseTimestamp_returnsPersistedValuePlusTimeout() {
        ...
        when(dataStore.getLong(eq(APP_CLOSE_TIMESTAMP_MILLIS), anyLong())).thenReturn(testTimestamp);
	...
	public void testSetLastKnownTimestamp_updatesPersistenceImmediately() {
        ...
        when(dataStore.getLong(eq(APP_CLOSE_TIMESTAMP_MILLIS), anyLong())).thenReturn(initialTimestamp);
		dataStoreCache = new LifecycleV2DataStoreCache(dataStore);
        ...
        verify(dataStore, times(1)).setLong(eq(APP_CLOSE_TIMESTAMP_MILLIS) ,appCloseTimestampCaptor.capture());
	...
	public void testSetLastKnownTimestamp_updatePersistence_multipleUpdates() {
        ...
        ArgumentCaptor<Long> appCloseTimestampCaptor = ArgumentCaptor.forClass(Long.class);
        verify(dataStore, times(3)).setLong(eq(APP_CLOSE_TIMESTAMP_MILLIS) ,appCloseTimestampCaptor.capture());
	...
	public void testSetLastKnownTimestamp_doesNotUpdatePersistence_whenSameTimestamp() {
        ...
        verify(dataStore, times(1)).setLong(eq(APP_CLOSE_TIMESTAMP_MILLIS) ,appCloseTimestampCaptor2.capture());
	...
	public void testSetGetStartTimestamp_updatesValueInPersistence() {
        when(dataStore.getLong(eq(APP_START_TIMESTAMP_MILLIS), anyLong())).thenReturn(twoMinutesBeforeCurrentTimeMilliseconds);
        ...
        verify(dataStore, times(1)).setLong(eq(APP_START_TIMESTAMP_MILLIS) ,appStartTimestampCaptor.capture());
	...
	public void testSetGetPauseTimestamp_updatesValueInPersistence() {
        when(dataStore.getLong(eq(APP_PAUSE_TIMESTAMP_MILLIS), anyLong())).thenReturn(twoMinutesBeforeCurrentTimeMilliseconds);
		dataStoreCache = new LifecycleV2DataStoreCache(dataStore);
        ...
        verify(dataStore, times(1)).setLong(eq(APP_PAUSE_TIMESTAMP_MILLIS) ,appPauseTimestampCaptor.capture());
