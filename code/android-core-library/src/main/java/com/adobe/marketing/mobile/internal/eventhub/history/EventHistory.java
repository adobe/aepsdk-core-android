...
public interface EventHistory {
	 ...
	 */
	void getEvents(EventHistoryRequest[] eventHistoryRequests, boolean enforceOrder,
				   EventHistoryResultHandler<Integer> handler);

	/**
	 * Delete rows from the {@link EventHistoryDatabase} that contain {@link Event}s which match the contents
	 ...
	 *                             {@code EventHistoryDatabase}
	 */
	void deleteEvents(EventHistoryRequest[] eventHistoryRequests, EventHistoryResultHandler<Integer> handler);
}
