...
public class FloatingButtonManagerTests {
	...
	private static ArgumentCaptor<Application.ActivityLifecycleCallbacks> activityLifecycleCallbacksArgumentCaptor;
	...
	public void displayAddsButtonToScreen_When_NoButtonAlreadyExists() {
		...
		((FloatingButtonManager)floatingButton).addManagedButton(MOCK_ACTIVITY_LOCAL_CLASS_NAME, floatingButtonViewSpy);
		//test
	...
	public void lifecycleCallbacksPlacesExistingButtonInProperXY_When_ActivityResumed() {
		...
		ArgumentCaptor<FloatingButtonView.OnPositionChangedListener> onPositionChangedListenerArgumentCaptor =
	...
	@Test
	public void lifecycleCallbacksPlacesExistingButtonInProperXY_When_ActivityResumedAfterOrientationChange() {
