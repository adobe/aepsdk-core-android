...
class MessageWebViewRunner implements Runnable {
	...
	private AEPMessageSettings settings;
	 ...
	 */
	public MessageWebViewRunner(final AEPMessage message) {
		this.message = message;
		this.settings = (AEPMessageSettings) message.getSettings();
	 ...
	 */
	private int getOriginX(final AEPMessageSettings settings) {
	 ...
	 */
	private int getOriginY(final AEPMessageSettings settings) {
