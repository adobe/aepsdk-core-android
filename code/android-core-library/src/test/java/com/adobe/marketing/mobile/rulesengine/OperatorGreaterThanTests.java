...
public class OperatorGreaterThanTests {
	...
	public void test_relationalOperator_Int_vs_Long() {
		...
		// test
		final RulesResult result = new ComparisonExpression<>(longOp, "greaterThan", intOp).evaluate(defaultContext());
	...
	public void test_relationalOperator_NonNumberOperands() {
		...
		final RulesResult result1 = new ComparisonExpression<>(op1, "greaterThan", op2).evaluate(defaultContext());
		final RulesResult result2 = new ComparisonExpression<>(op1, "greaterEqual", op2).evaluate(defaultContext());
		final RulesResult result3 = new ComparisonExpression<>(op1, "lessThan", op2).evaluate(defaultContext());
		final RulesResult result4 = new ComparisonExpression<>(op1, "lessEqual", op2).evaluate(defaultContext());
