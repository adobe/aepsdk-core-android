...
class LifecycleV2DataConverter {
	...
	/**
	 * Converts {@link DeviceInforming.DeviceType} value to {@link XDMLifecycleDeviceTypeEnum}.
	 ...
	 */
	static XDMLifecycleDeviceTypeEnum toDeviceTypeEnum(final DeviceInforming.DeviceType deviceType) {
		if (deviceType == null) {
			return null;
		}
	...
	/**
	 * Converts {@link DeviceInforming#getRunMode()} String to {@link XDMLifecycleEnvironmentTypeEnum}. It currently only supports the
