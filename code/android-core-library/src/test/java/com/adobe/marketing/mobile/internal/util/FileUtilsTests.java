...
import static com.adobe.marketing.mobile.internal.util.FileTestHelper.MOCK_CONFIG_JSON;
import static com.adobe.marketing.mobile.internal.util.FileTestHelper.MOCK_FILE_NAME;
...
public class FileUtilsTests {
	...
	public void testClassIsWellDefined() {
		try {
			TestHelper.assertUtilityClassWellDefined(FileUtils.class);
		} catch (Exception e) {
	...
	public void testIsValidDirectory_when_Null() {
		// Test
		final boolean isValid = FileUtils.isValidDirectory(null);
		// Verify
	...
	public void testIsValidDirectory_when_File() {
		...
		final boolean isValid = FileUtils.isValidDirectory(new File(fileTestHelper.getCacheDirectory() + File.separator +
								MOCK_FILE_NAME));
		// Verify
	...
	public void testIsValidDirectory_when_Directory() {
		// Test
		final boolean isValid = FileUtils.isValidDirectory(fileTestHelper.getCacheDirectory());
		// Verify
	...
	public void testReadJsonStringFromFile_When_ValidFile() {
		String content = FileUtils.readStringFromFile(fileTestHelper.placeSampleCacheFile());
		assertEquals(MOCK_CONFIG_JSON, content);
	}

	@Test
	public void testReadJsonStringFromFile_When_NullFile_Then_ReturnsNull() {
		String content = FileUtils.readStringFromFile(null);
		assertNull(content);
	}

	@Test
	public void testReadJsonStringFromFile_When_DirectoryInsteadOfFile_Then_ReturnsNull() {
		String content = FileUtils.readStringFromFile(fileTestHelper.placeSampleCacheDirectory("testDirectory",
						 "testFileName"));
		assertNull(content);
	}
}