...
// handlers and when overriding the network stack in place of internal network connection implementation.
public interface HttpConnecting {
	...
	/**
	 * Returns a value for the response property key that might have been set when a connection was made to the
