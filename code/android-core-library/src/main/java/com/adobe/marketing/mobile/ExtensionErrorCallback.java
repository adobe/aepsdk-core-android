...
/**
 * Callback interface to receive errors from the {@code ExtensionApi} methods.
 * Implementers should override this to see what errors are occurring and handle them as needed.
 *
 * @param <ExtensionError> the object type passed to the {@link #error(Object)} method when an error occurs
 *
