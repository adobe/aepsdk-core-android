...
class SQLiteDatabaseHelper {
	 ...
	 */
	boolean createTableIfNotExist(final String dbPath, final String query) {
	 ...
	 */
	boolean insertRow(final String dbPath, final String tableName, final Map<String, Object> data) {
		SQLiteDatabase database = null;
	 ...
	 */
	List<ContentValues> query(final String dbPath, final String tableName, final String[] columns, final int count) {
		SQLiteDatabase database = null;
		Cursor cursor = null;
	 ...
	 */
	int getTableSize(final String dbPath, final String tableName) {
	 ...
	 */
	int removeRows(final String dbPath, final String tableName, final String orderBy, final int count) {
		SQLiteDatabase database = null;
	 ...
	 */
	boolean clearTable(final String dbPath, final String tableName) {
		SQLiteDatabase database = null;
	 ...
	 */
	SQLiteDatabase openDatabase(final String filePath, final DatabaseOpenMode dbOpenMode) throws SQLiteException {
