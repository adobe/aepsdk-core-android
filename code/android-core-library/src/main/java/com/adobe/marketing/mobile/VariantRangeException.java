...
/**
 * Exception thrown by {@code Variant} and {@code EventData} to indicate that a value was out of
 * range.
 */
class VariantRangeException extends VariantException {
	 ...
	 */
	public VariantRangeException(final String message) {
		super(message);
	}
	 ...
	 */
	public VariantRangeException(final Exception inner) {
		super(inner);
	}
}
