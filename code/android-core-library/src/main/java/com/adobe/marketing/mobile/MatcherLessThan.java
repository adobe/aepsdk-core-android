...
/**
 * A rule condition matcher which evaluates if a given value is less than any of this matcher's {@code values}.
 */
final class MatcherLessThan extends Matcher {
	 ...
	 * @return true if {@code value} is less than any of this {@code Matcher}'s values
	 */
	@Override
	...
	@Override public String toString() {
		...
		for (Object value : values) {
			...
			matcherStringBuilder.append(" LESS THAN ");
