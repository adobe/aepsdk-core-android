...
public interface UIService {
	 ...
	 *
	 * @param notificationSetting An {@link NotificationSetting} instance used for building a local notification.
	 */
	 ...
	 * @param listener         FullscreenMessageDelegate for listening to Messaging extension in-app message events
	 * @param isLocalImageUsed If true, an image from the app's assets directory will be used for the fullscreen message.
