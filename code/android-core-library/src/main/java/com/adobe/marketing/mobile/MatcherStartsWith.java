...
/**
 * A rule condition matcher which evaluates if a given value starts with any of this matcher's {@code values}.
 */
final class MatcherStartsWith extends Matcher {
	 ...
	 * @return true if {@code value} starts with any of this {@code Matcher}'s values
	 */
	@Override
	...
	public String toString() {
		...
		for (Object value : values) {
			...
			matcherStringBuilder.append(" STARTS WITH ");
