...
public class NetworkServiceTests {
    ...
    public void testConnectAsync_NullUrl() throws InterruptedException {
        try (MockedConstruction<HttpConnectionHandler> connectionHandlerConstruction = mockConstruction(HttpConnectionHandler.class,
                (mock, context) -> when(mock.setCommand(Mockito.any(HttpMethod.class))).thenReturn(true))) {
    ...
    public void testConnectAsync_DefaultHeaders() throws InterruptedException {
        try (MockedConstruction<HttpConnectionHandler> ignored = mockConstruction(HttpConnectionHandler.class,
                (mock, context) -> {
