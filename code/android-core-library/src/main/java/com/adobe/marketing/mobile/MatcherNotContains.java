...
/**
 * A rule condition matcher which evaluates if a given value does not contain any of this matcher's {@code values}.
 */
final class MatcherNotContains extends MatcherContains {
	 ...
	 * @return true if {@code value} does not contain any of this {@code Matcher}'s values
	 */
	@Override
	...
	@Override public String toString() {
		...
		for (Object value : values) {
			...
			matcherStringBuilder.append(" NOT CONTAINS ");
