 ...
 * file using the parameter {@code global.privacy}. Use {@code AdobeMobileMarketing.setPrivacyStatus()} API
 * to override the default privacy status.
 * <p>
 * (TODO - verify the documentation link is accurate for AMSDK V5)
 * To learn more about the Adobe Mobile Privacy Status, view the online documentation at
 * <a href="https://marketing.adobe.com/resources/help/en_US/mobile/ios/privacy.html">https://marketing.adobe.com/resources/help/en_US/mobile/ios/privacy.html</a>
 *
 */
public enum MobilePrivacyStatus {
	 ...
	 * <p>
	 * If the text provided is not valid, {@link #UNKNOWN} will be returned.
	 *
