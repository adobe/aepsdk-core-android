...
internal object AutoCarouselTemplateNotificationBuilder {
    ...
    internal fun construct(
        ...
        val expandedLayout = RemoteViews(context.packageName, R.layout.push_template_auto_carousel)
        ...
        val items: ArrayList<CarouselPushTemplate.CarouselItem> = pushTemplate.getCarouselItems()
        val downloadedImageUris = populateImages(
            context, trackerActivity, cacheService, expandedLayout, pushTemplate, items, packageName
        )
