...
public interface CacheResult {
    ...
    /**
     * Gets the metadata of the item that is retrieved from the cache.
     * Note that this metadata may also contain additional keys used internally
     * by {@code CacheService} to facilitate caching.
     *
