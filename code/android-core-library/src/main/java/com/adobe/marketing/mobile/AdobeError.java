...
public class AdobeError implements Serializable {
	 ...
	 */
	public static final AdobeError UNEXPECTED_ERROR = new AdobeError("general.unexpected",
			0);

	/**
	 *  when a timeout happens.
	 */
	public static final AdobeError CALLBACK_TIMEOUT = new
	AdobeError("general.callback.timeout", 1);

	/**
	 *  when a callback is null.
	 */
	public static final AdobeError CALLBACK_NULL = new
	AdobeError("general.callback.null", 2);

	/**
	 *  when a extension is not initialized.
	 */
	public static final AdobeError EXTENSION_NOT_INITIALIZED = new
	AdobeError("general.extension.not.initialized", 11);
