...
public class LocalDataStoreServiceTests {
	...
	public void testSetString_Overwrite() throws Exception {
		...
		String value = this.sharedPreferencesNamedCollection.getString("testSetString_Overwrite", null);
		assertEquals("string2", value);
	}

	@Test
	public void testGetString_EntryNotInSharedPreferences() throws Exception {
		String value = this.sharedPreferencesNamedCollection.getString("testGetString_NotInSharedPrefs", null);
		assertNull(value);
	}
	...
	public void testSetDouble_Overwrite() throws Exception {
		...
		double value = this.sharedPreferencesNamedCollection.getDouble("testSetDouble_Overwrite", 0d);
		assertEquals(20.5678d, value);
	}

	@Test
	public void testGetDouble_EntryNotInSharedPreferences() throws Exception {
		double value = this.sharedPreferencesNamedCollection.getDouble("testGetDouble_EntryNotInSharedPrefs", 0);
	...
	public void testGetLong_EntryNotInSharedPreferences() throws Exception {
		long value = this.sharedPreferencesNamedCollection.getLong("testGetLong_NotInSharedPrefs", 0L);
	...
	public void testGetFloat_EntryNotInSharedPreferences() throws Exception {
		float value = this.sharedPreferencesNamedCollection.getFloat("testGetFloat_NotInSharedPrefs", 0f);
	...
	public void testSetGetBoolean_Happy() throws Exception {
		...
		boolean value = this.sharedPreferencesNamedCollection.getBoolean("testSetBoolean_Happy", false);
		assertTrue(value);
	}
	...
	public void testSetBoolean_Overwrite() throws Exception {
		...
		boolean value = this.sharedPreferencesNamedCollection.getBoolean("testSetBoolean_Overwrite", false);
		assertTrue(value);
	}

	@Test
	public void testGetBoolean_EntryNotInSharedPreferences() throws Exception {
		boolean value = this.sharedPreferencesNamedCollection.getBoolean("testGetBoolean_NotInSharedPrefs", true);
		assertTrue(value);
	}
	...
	public void testContains_EntryNotInSharedPreferences() throws Exception {
		assertFalse(this.sharedPreferencesNamedCollection.contains("testContains_Int_NotInSharedPrefs"));
		assertFalse(this.sharedPreferencesNamedCollection.contains("testContains_Long_NotInSharedPrefs"));
		assertFalse(this.sharedPreferencesNamedCollection.contains("testContains_Double_NotInSharedPrefs"));
		assertFalse(this.sharedPreferencesNamedCollection.contains("testContains_Float_NotInSharedPrefs"));
		assertFalse(this.sharedPreferencesNamedCollection.contains("testContains_String_NotInSharedPrefs"));
	}
	...
	public void testRemove_EntryNotInSharedPreferences() throws Exception {
		...
		assertFalse(this.sharedPreferencesNamedCollection.contains("testRemove_Happy_NotInSharedPrefs"));
	}
	...
	public void testRemoveAll_Happy() throws Exception {
		...
		assertEquals(0d, this.sharedPreferencesNamedCollection.getDouble("testRemoveAll_Double", 0d));
