...
class HttpConnectionHandler {
	...
	protected enum Command {
		 ...
		 * <p>
		 * Set the {@code doOutputSetting} flag to true if you intend to write data to the URL connection, otherwise set it to false.
		 *
		 * @param doOutputSetting {@code boolean} indicating whether this command writes to the connection output stream
		 */
		...
		/**
		 * Returns the setting specifying whether this command will need to write data to the URL connection.
		 *
		 * @return {@code boolean} indicating whether this command writes to the connection output stream
		 */
	 ...
	 * <p>
	 * Initializes {@link #httpsUrlConnection} with a {@link java.net.URLConnection} instance representing the connection, returned by a call to
	 ...
	 * <p>
	 * The command should be set before {@link #connect(byte[])} method is called.
	 *
	...
	boolean setCommand(final HttpMethod command) {
		...
		try {
			...
			//Set doOutput flag for this URLConnection. A true value indicates intention to write data to URL connection, read otherwise.
	 ...
	 * <p>
	 * This method should be called before {@link #connect(byte[])} is called.
	 *
	 * @param requestProperty {@code Map<String, String>} containing the header fields and their values
	 ...
	 * <p>
	 * If the {@code command} set for this connection is {@link Command#POST}, then the {@code payload} will
	 * be sent to the server, otherwise ignored.
	 *
