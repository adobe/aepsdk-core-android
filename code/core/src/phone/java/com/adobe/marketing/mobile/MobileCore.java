...
public final class MobileCore {
    ...
    public static void setApplication(@NonNull final Application application) {
        ...
        // Migration and EventHistory operations must complete in a background thread before any extensions are registered.
        ...
        EventHub.Companion.getShared().executeInEventHubExecutor(() -> {
            try {
