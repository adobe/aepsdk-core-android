...
public final class EventSource {
    ...
    public static final String REQUEST_TRACKER = "com.adobe.eventSource.requestTracker";
    public static final String TRACK_MEDIA = "com.adobe.eventSource.trackMedia";
    public static final String SESSION_CREATED = "com.adobe.eventSource.sessionCreated";
}
