...
class ConfigurationListenerBootEvent extends ModuleEventListener<ConfigurationExtension> {
	/**
	 * Creates a ConfigurationListenerBootEvent instance
	 *
	 ...
	 * @see EventSource
	 */
	ConfigurationListenerBootEvent(final ConfigurationExtension module, final EventType type,
	...
	public void hear(final Event event) {
		parentModule.handleBootEvent(event);
	}
}
