...
public class ContextDataUtil {
    private static final String CLASS_TAG = "ContextDataUtil";
    ...
    public static Map<String, Object> cleanContextDataDictionary(final Map<String, String> data) {
        Map<String, Object> tempContextData = new HashMap<>();
    ...
    static String appendContextData(final Map<String, String> referrerData, final String source) {
        ...
        try {
            ...
            Log.debug(CoreConstants.LOG_TAG, CLASS_TAG, "Context data matcher failed with %s", exception);
        ...
        for (String param : contextDataString.split("&")) {
            if (param.endsWith(".") && !param.contains("=")) {
                ...
                try {
                    ...
                    Log.warning(CoreConstants.LOG_TAG, CLASS_TAG, "Appending the context data information failed with %s", e);
                }
            }
        }
