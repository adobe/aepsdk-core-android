...
public class MobileCoreRegistrationJavaTests {
    ...
    public void testScenario1() throws InterruptedException {
        ...
        AdobeCallbackWithError<String> callback = new AdobeCallbackWithError<String>(){
            @Override
            public void fail(AdobeError error) { latch.countDown();}
            @Override
        ...
        assertEquals(
                new HashSet<String>(Arrays.asList("Sample1_ID", "Sample1Kt_ID")),
                capturedIds
        );
    }
    ...
    public void testScenario2() throws InterruptedException {
        ...
        MobileCore.setApplication(mock(Application.class));
        List<Class<? extends Extension>> extensions = Arrays.asList(
                Sample2Extension.class,
                Sample2KtExtension.class
        );
        ...
        assertEquals(
                new HashSet<>(Arrays.asList("Sample2_ID", "Sample2Kt_ID")),
                capturedIds
        );
    }
}
