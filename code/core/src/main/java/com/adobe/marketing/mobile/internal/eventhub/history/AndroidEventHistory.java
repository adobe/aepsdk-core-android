...
public class AndroidEventHistory implements EventHistory {
     ...
     *     were found in the order specified in the eventHistoryRequests array, a "0" if the events
     *     were not found in the order specified, and a "-1" if the database failure occurred.
     */
    @Override
