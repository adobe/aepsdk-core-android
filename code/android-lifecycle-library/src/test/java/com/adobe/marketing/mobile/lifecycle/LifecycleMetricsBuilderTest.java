...
public class LifecycleMetricsBuilderTest {
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenInstallEvent() {
		...
		Map<String, String> installData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore,
				1483889568L)
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenInstallEvent_WhenLifecycleDataStoreIsNull() {
		// Sunday, November 10, 2017 7:32:48 AM
		Map<String, String> installData = new LifecycleMetricsBuilder(mockDeviceInfoService, null, 1510327968L)
		.addInstallData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenLaunchEvent() {
		...
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_INSTALL_DATE), anyLong())).thenReturn(1483255968L);
		// Saturday January 07, 2017 23:32:48 (pm) GMT-08:00
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_LAST_USED_DATE), anyLong())).thenReturn(1483860768L);
		// Sunday January 08, 2017 00:32:48 (am) GMT-08:00
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_PAUSE_DATE), anyLong())).thenReturn(1483864368L);

		// Saturday January 07, 2017 23:37:48 (pm)  GMT-08:00
		Map<String, String> launchData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1483861068L)
		.addLaunchData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenLaunchEvent_LaunchNewDay() {
		...
		Map<String, String> launchData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1483965168L)
		.addLaunchData().build();
	...
	public void testLifecycleBuilder_NoDaysSinceLastLaunch_PriorUpgradeYearIsInFuture() {
		...
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_INSTALL_DATE), anyLong())).thenReturn(1930346131L);
		//Monday, March 3, 2031 11:15:31 PM
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_LAST_USED_DATE), anyLong())).thenReturn(1930346131L);
		// Sunday January 08, 2017 00:32:48 (am) GMT-08:00

		// Tuesday, January 12, 2016 8:32:48 PM
		Map<String, String> upgradeData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore,
				1452630768L)
	...
	public void testLifecycleBuilder_NoDaysSinceLastLaunch_PriorUpgradeYearIsInvalid() {
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_INSTALL_DATE), anyLong())).thenReturn(400L);
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_LAST_USED_DATE), anyLong())).thenReturn(400L);
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenLaunchEvent_LaunchEndOfDayToBeginningOfDay() {
		...
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_INSTALL_DATE), anyLong())).thenReturn(1483259568L);
		// Sunday, January 8, 2017 11:55:55 PM GMT-08:00
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_LAST_USED_DATE), anyLong())).thenReturn(1483948555L);
		// Monday, January 9, 2017 12:00:01 AM GMT-08:00
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_PAUSE_DATE), anyLong())).thenReturn(1483948801L);
		when(lifecycleDataStore.getInt(eq(DATASTORE_KEY_LAUNCHES), anyInt())).thenReturn(10);

		// Monday, January 9, 2017 12:00:55 AM GMT-08:00
		Map<String, String> launchData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1483948855L)
		.addLaunchData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenLaunchEvent_LaunchNewMonth() {
		...
		Map<String, String> launchData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1486539168L)
		.addLaunchData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenLaunchEvent_LaunchEndOfMonthToBeginningOfMonth() {
		...
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_LAST_USED_DATE), anyLong())).thenReturn(1485934368L);
		// Tuesday, January 31, 2017 11:50:48 PM GMT-08:00
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_PAUSE_DATE), anyLong())).thenReturn(1485935448L);

		// Wednesday, February 1, 2017 12:32:48 AM GMT-08:00
		Map<String, String> launchData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1485937968L)
		.addLaunchData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenLaunchEvent_LaunchFirstOfMonthToFirstOfMonth() {
		...
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_INSTALL_DATE), anyLong())).thenReturn(1483302768L);
		// Sunday, October 1, 2017 1:01:00 AM
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_LAST_USED_DATE), anyLong())).thenReturn(1506844860L);
		// Sunday, October 1, 2017 1:10:00 AM
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_PAUSE_DATE), anyLong())).thenReturn(1506845400L);

		// Wednesday, November 1, 2017 1:01:00 AM GMT-08:00
		Map<String, String> launchData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1509523260L)
		.addLaunchData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenLaunchEvent_LaunchSameDayNewYear() {
		...
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_INSTALL_DATE), anyLong())).thenReturn(1475308860L);
		// Saturday October 01, 2016 01:01:00 (am) GTM-8
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_LAST_USED_DATE), anyLong())).thenReturn(1475308800L);
		// Saturday October 01, 2016 01:10:00 (am) GTM-8
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_PAUSE_DATE), anyLong())).thenReturn(1475309400L);
		when(lifecycleDataStore.getInt(eq(DATASTORE_KEY_LAUNCHES), anyInt())).thenReturn(1);

		// Sunday October 01, 2017 01:10:00 (am) GMT-08:00
		Map<String, String> launchData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1506845400L)
		.addLaunchData().build();
	...
	public void testLifecycleBuilder_ReturnsEmptyMap_WhenLaunchEvent_WhenLifecycleDataStoreNull() {
		...
		Map<String, String> launchData = new LifecycleMetricsBuilder(mockDeviceInfoService, null, 1506845400L)
		.addLaunchData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenUpgradeEvent() {
		when(lifecycleDataStore.getInt(eq(DATASTORE_KEY_LAUNCHES_AFTER_UPGRADE), anyInt())).thenReturn(5);
		...
		verify(lifecycleDataStore, times(1)).setLong(eq(DATASTORE_KEY_UPGRADE_DATE) ,upgradeDateCaptor.capture());
		...
		verify(lifecycleDataStore, times(1)).setInt(eq(DATASTORE_KEY_LAUNCHES_AFTER_UPGRADE) ,launchesAfterUpgradeCaptor.capture());
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenUpgradeEvent_PriorUpgradeYear() {
		...
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_UPGRADE_DATE), anyLong())).thenReturn(1421091168L);
		when(lifecycleDataStore.getString(eq(DATASTORE_KEY_LAST_VERSION), anyString())).thenReturn("1.1.1");
		when(lifecycleDataStore.getInt(eq(DATASTORE_KEY_LAUNCHES_AFTER_UPGRADE), anyInt())).thenReturn(30);
	...
	public void testLifecycleBuilder_NoDaysSinceLastUpgrade_PriorUpgradeYearIsInFuture() {
		//Monday, March 3, 2031 11:15:31 PM
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_UPGRADE_DATE), anyLong())).thenReturn(1930346131L);
	...
	public void testLifecycleBuilder_NoDaysSinceLastUpgrade_PriorUpgradeYearIsInvalid() {
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_UPGRADE_DATE), anyLong())).thenReturn(400L);
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenUpgradeEvent_PriorUpgradeLeapYear() {
		// Tuesday, January 12, 2016 8:32:48 PM
		when(lifecycleDataStore.getLong(eq(DATASTORE_KEY_UPGRADE_DATE), anyLong())).thenReturn(1452630768L);
		when(lifecycleDataStore.getString(eq(DATASTORE_KEY_LAST_VERSION), anyString())).thenReturn("1.1.1");
		when(lifecycleDataStore.getInt(eq(DATASTORE_KEY_LAUNCHES_AFTER_UPGRADE), anyInt())).thenReturn(0);
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenUpgradeEvent_NoUpgradeWhenDataStoreNull() {
		Map<String, String> upgradeData = new LifecycleMetricsBuilder(mockDeviceInfoService, null, 1452601968L)
		.addUpgradeData(false).build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenUpgradeEvent_WhenLifecycleDataStoreIsNull() {
		// Sunday, November 10, 2017 7:32:48 AM
		Map<String, String> upgradeData = new LifecycleMetricsBuilder(mockDeviceInfoService, null, 1510327968L)
		.addUpgradeData(true).build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenCrashEvent() {
		Map<String, String> crashData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore,
				1452601968L)
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenCoreEvent() {
		...
		Map<String, String> coreData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1452601968L)
		.addCoreData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenCoreEvent_DataStoreNull() {
		Map<String, String> coreData = new LifecycleMetricsBuilder(mockDeviceInfoService, null, 1452601968L)
		.addCoreData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenAddGeneralDataCalled_PM() {
		...
		// Saturday January 07, 2017 23:37:48 (pm)  GMT-08:00
		Map<String, String> generalData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1483861068L)
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenAddGeneralDataCalled_AM() {
		...
		// Monday, January 9, 2017 12:00:55 AM GMT-08:00
		Map<String, String> generalData = new LifecycleMetricsBuilder(mockDeviceInfoService, lifecycleDataStore, 1483948855L)
		.addGenericData().build();
	...
	public void testLifecycleBuilder_ReturnsCorrectData_WhenLifecycleDataStoreIsNull() {
		// Saturday January 07, 2017 23:37:48 (pm)  GMT-08:00
		Map<String, String> generalData = new LifecycleMetricsBuilder(mockDeviceInfoService, null, 1483861068L)
		.addGenericData().build();
