...
class MessageArrangementMapperTest {
    ...
    fun `Test #getVerticalArrangement with all MessageAlignments`() {
        assertEquals(
            Arrangement.Top,
            MessageArrangementMapper.getVerticalArrangement(
        ...
        assertEquals(
            Arrangement.Bottom,
            MessageArrangementMapper.getVerticalArrangement(
                InAppMessageSettings.MessageAlignment.BOTTOM
            )
        )
        assertEquals(
            Arrangement.Center,
        ...
        assertEquals(
            Arrangement.Center,
            MessageArrangementMapper.getVerticalArrangement(
                InAppMessageSettings.MessageAlignment.LEFT
            )
        )
        assertEquals(
            Arrangement.Center,
    ...
    fun `Test #getHorizontalArrangement with all MessageAlignments`() {
        assertEquals(
            Arrangement.Start,
            MessageArrangementMapper.getHorizontalArrangement(
                InAppMessageSettings.MessageAlignment.LEFT
            )
        )
        assertEquals(
