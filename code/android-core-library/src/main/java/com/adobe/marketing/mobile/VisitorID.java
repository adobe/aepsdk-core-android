...
public class VisitorID {
	...
	public static final VariantSerializer<List<VisitorID>> LIST_VARIANT_SERIALIZER = new
	TypedListVariantSerializer<VisitorID>(new VisitorIDVariantSerializer());
	...
	public VisitorID(final String idOrigin, final String idType, final String id,
		...
		if (StringUtils.isNullOrEmpty(cleanIdType)) {
		...
		if (StringUtils.isNullOrEmpty(id)) {
			Log.debug("VisitorID", "The custom VisitorID should not have null/empty id, this VisitorID will be ignored");
		}
