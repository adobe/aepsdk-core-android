...
public class NotificationSetting {
	 ...
	 */
	public static NotificationSetting build(final String identifier, final String content, final long fireDate,
	...
	/**
	 *
	 * @return a specific date and time to show the notification, represented as number of seconds since epoch
	 */
