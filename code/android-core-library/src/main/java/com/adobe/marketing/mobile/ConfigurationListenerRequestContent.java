...
class ConfigurationListenerRequestContent extends ModuleEventListener<ConfigurationExtension> {
	...
	/**
	 * Creates a ConfigurationListenerRequestContent instance.
	 *
	 ...
	 * @see EventSource
	 */
	ConfigurationListenerRequestContent(final ConfigurationExtension module, final EventType type,
										final EventSource source) {
		super(module, type, source);
	}

	/**
	 * Handler for events requesting configuration retrieval.
	 *
	...
	public void hear(final Event event) {
		parentModule.handleEvent(event);
	}
}
