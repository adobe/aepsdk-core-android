...
/**
 * A rule condition matcher which evaluates if a given value is greater than or equal to
 * any of this matcher's {@code values}.
 */
final class MatcherGreaterThanOrEqual extends Matcher {
	 ...
	 * @return true if {@code value} is greater than or equal to any of this {@code Matcher}'s values
	 */
	@Override
	...
	@Override public String toString() {
		...
		for (Object value : values) {
			...
			matcherStringBuilder.append(" GREATER THAN OR EQUALS ");
