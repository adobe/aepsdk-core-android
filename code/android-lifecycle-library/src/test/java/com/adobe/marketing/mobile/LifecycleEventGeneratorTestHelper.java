...
public class LifecycleEventGeneratorTestHelper {
    ...
    public static Event createLifecycleEvent(final Map<String, Object> eventData, final long timestamp) {
        return new Event.Builder(null, EventType.LIFECYCLE, EventSource.REQUEST_CONTENT)
                .setTimestamp(timestamp)
                .setEventData(eventData)
                .build();
    }
