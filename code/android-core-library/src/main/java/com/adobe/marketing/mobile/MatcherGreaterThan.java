...
/**
 * A rule condition matcher which evaluates if a given value is greater than any of this matcher's {@code values}.
 */
final class MatcherGreaterThan extends Matcher {
	 ...
	 * @return true if {@code value} is greater than any of this {@code Matcher}'s values
	 */
	@Override
	...
	@Override public String toString() {
		...
		for (Object value : values) {
			...
			matcherStringBuilder.append(" GREATER THAN ");
