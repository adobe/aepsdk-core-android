...
public interface CacheService {
     ...
     */
    boolean set(@NonNull final String cacheName, @NonNull final String key, @NonNull final CacheEntry value);
     ...
     */
    @Nullable
    CacheResult get(@NonNull final String cacheName, @NonNull final String key);
