...
/**
 * A simple thread-safe implementation of a {@link DataQueue}.
 * The {@link DataEntity} objects are held in memory by an instance of this {@code DataQueue}.
 */
public class SimpleDataQueue implements DataQueue {
	 ...
	 * @throws InterruptedException if any thread interrupted this thread while waiting for the data queue to empty
	 */
