...
public class FullscreenMessageActivity extends Activity {
    private static final String SELF_TAG = "FullscreenMessageActivity";
    public static AndroidFullscreenMessage message;
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        if (message == null) {
            Log.debug(CoreConstants.LOG_TAG, SELF_TAG, "%s (message), failed to show the fullscreen message.", Log.UNEXPECTED_NULL_VALUE);
            dismiss();
            return;
        }
    ...
    public void onResume() {
        ...
        try {
            ...
            Log.error(CoreConstants.LOG_TAG, SELF_TAG, "Failed to show the fullscreen message (%s).", ex.toString());
            dismiss();
        }
    }
